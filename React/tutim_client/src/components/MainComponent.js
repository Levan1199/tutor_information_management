...
import {fetchTeacherReg, fetchStudentReg, postTeacherReg,
...
class Main extends Component{
  ...
  render(){
    ...
    const RenderProfile = () => {
      // console.log('xx',this.props.teacherRegs.teacherRegs.filter((teacher)=>teacher.teacherId == this.props.auth.teacherId)[0]);
      return(
        this.props.auth.isAuthenticated
        ?
